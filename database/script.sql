...
COPY BooksTagsTemp(GoodReadsBookId, TagId, Counter)
From '/home/quenar/Desktop/DLS/Project/netbook/netbook-content/database/bookstags.csv' DELIMITER ',' CSV HEADER;

INSERT INTO BooksTags SELECT DISTINCT ON (GoodReadsBookId, TagId) * FROM BooksTagsTemp;
...
FROM '/home/quenar/Desktop/DLS/Project/netbook/netbook-content/database/authors.csv' DELIMITER ',' CSV HEADER;
